...
public class NotificationFactorySample extends AbsNotificationFactory
{
    ...
    public Notification onGenerateNotification(PushData pushData)
    {
        ...
        if (pushData.getIconBackgroundColor() != null)
        {
            ...
            notificationBuilder.setColor(Color.parseColor("#feafea"));
        }
        ...
        if (null != pushData.getLargeIcon())
        {
            ...
            notificationBuilder.setLargeIcon(BitmapFactory.decodeResource(getContext().getResources(), R.drawable.pw_notification));
        }
